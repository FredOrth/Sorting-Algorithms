...
//         LevelSort<Integer> levelAdaptive = new LevelSort<>(LevelSort.sortMode.adaptive, 1); // c arugment set to 1, as that would be the same as not using it, IE. the base-case.

//         levelAdaptive.sort(testingArray1);
...
//     //     LevelSort bioAdaptive = new LevelSort<>(5, true);
//     //     bioAdaptive.sort(emptyArray);
//     //     String[] emptyTestArray = {};
//     //     assertEquals(emptyTestArray, emptyArray);

//     //     LevelSort bioAdaptiveNonAdaptive = new LevelSort<>(5, false);
...
//     //     LevelSort<String> bioAdaptive = new LevelSort<>(3, true);
...
//     //     LevelSort<String> bioNonAdaptive = new LevelSort<>(3, false);
...
//     //     LevelSort<StableTestClass> bioAdaptive = new LevelSort<>(3, true);
...
//     //     LevelSort<StableTestClass> bioNonAdaptive = new LevelSort<>(3, false);
...
//     //     LevelSort<StableTestClass> bioAdaptive = new LevelSort<>(4, true);
...
//     //     LevelSort<StableTestClass> bioNonAdaptive = new LevelSort<>(4, false);
...
//     //     LevelSort<Integer> bioAdaptive = new LevelSort<>(3, true);
...
//     //     LevelSort<Integer> bioNonAdaptive = new LevelSort<>(3, true);
